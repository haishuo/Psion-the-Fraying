...
> **Why the undead are safe.** A psidolon cannot take a Kindred host: the Beast occupies the seat a psidolon would need to drown, and rejects the intrusion. This is why the Untethered prey on fragile mortals and the Gifted, never on the abundant, durable undead — and it is the hinge the entire [Interred](Psidolons%20-%20The%20Untethered.md) concept turns on.
...
Has held a host for months or years, masks expertly, has built defenses. The standard Inquisition quarry — and the kind of entity [Marcus Thiel](Marcus_Thiel.md) has spent a decade preparing to face alone.
